...
function _getDeliveryProvider(yampiBody) {
...
function _buildEntrega(yampiBody) {
  ...
  switch (sku) {
    ...
    default:
      const _motoboyDelivery = _getDeliveryProvider(yampiBody)
      if (_motoboyDelivery) {
...
async function getSpecificOrderYampi(){

}

async function getSpecificOrderGuru(){
